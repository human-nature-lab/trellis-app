// import FormService from '@/services/test/FormService.test'
import describeInEachEnv from '../util'
let FormService = null
describeInEachEnv(`FormService.spec`, (env) => {
  describe(`FormService.${env}`, () => {
    before(() => {
      FormService = require('@/factories/ServiceFactory').FormService
    })
