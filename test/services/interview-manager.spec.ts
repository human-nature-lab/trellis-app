...
function next (manager: InterviewManager) {
  return simpleActionPush(manager, AT.next)
}
function prev (manager: InterviewManager) {
  return simpleActionPush(manager, AT.previous)
}
